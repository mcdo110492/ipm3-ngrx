...
export const sidenavMetaData2  = [
    { title : 'Accounting' , isHeader : true},
    { title : 'Dashboard 1' , link : '', icon : 'menu', isHeader : false },
    { title : 'Dashboard 2' , link : '', icon : 'menu', isHeader : false },
    { title : 'Dashboard 3' , link : '', icon : 'menu', isHeader : false },
    { title : 'Dashboard 4' , link : '', icon : 'menu', isHeader : false },
];
